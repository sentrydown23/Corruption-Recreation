...
var noteImage = 'stages/school/ui/arrows-pixels';
var noteSustainImage = 'stages/school/ui/arrowEnds';
var evilNoteImage = 'pixelui/arrows-pixels-roots';
var evilnoteSustainImage = 'pixelui/arrowEnds-roots';
...
function onNoteCreation(event) {
	...
	if (event.note.isSustainNote) {
		if (SONG.meta.name == "roots") {
			note.loadGraphic(Paths.image(evilnoteSustainImage), true, 7, 6);
		} else {
			note.loadGraphic(Paths.image(noteSustainImage), true, 7, 6);
		}
		...
		if (SONG.meta.name == "roots") {
			note.loadGraphic(Paths.image(evilNoteImage), true, 17, 17);
		} else {
			note.loadGraphic(Paths.image(noteImage), true, 17, 17);
		}
