...
function createPhrases()
{
    ...
    phrase1.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text1"));
    phrase1.scrollFactor.set(0, 0);
    phrase1.screenCenter();
    phrase1.cameras = [camHUD];
    insert(0, phrase1);

    phrase2.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text2"));
    phrase2.scrollFactor.set(0, 0);
    phrase2.screenCenter();
    phrase2.cameras = [camHUD];
    insert(0, phrase2);

    phrase3.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text3"));
    phrase3.scrollFactor.set(0, 0);
    phrase3.screenCenter();
    phrase3.cameras = [camHUD];
    insert(0, phrase3);

    phrase4.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text4"));
    ...
    phrase5.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text5"));
    phrase5.scrollFactor.set(0, 0);
    phrase5.screenCenter();
    phrase5.cameras = [camHUD];
    insert(0, phrase5);

    phrase6.loadGraphic(Paths.image("stages/screen/tormentor/dialogue/text6"));
