...
class Options
{
	 ...
	 * SETTINGS
	 */
	public static var vigtoggle:Bool = true;
	public static var kadearrows:Bool = true;
	public static var forcefull:Bool = false;
	public static var disParticles:Bool = true;
